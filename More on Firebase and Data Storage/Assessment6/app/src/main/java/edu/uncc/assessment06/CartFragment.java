...
public class CartFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        listenerRegistration = db.collection("carts").whereEqualTo("uid", mAuth.getCurrentUser().getUid())
    ...
    void getAndDisplayTotal(){
        ...
        binding.textViewTotal.setText("Total: $" + String.valueOf(total)); // format to two places
    }
